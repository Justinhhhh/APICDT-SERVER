...
function MatchCard({ id, matchType, teamA, teamB, matchTime }) {
    ...
    <Box>
            {role === 'Judge' ? <LinkBox align='center' justify='center' w={'75vw'}>
                ...
                <Card justify={'center'} align={'center'} w={'75vw'} h={'30vh'} boxShadow='xl' color='#dedede' mt={10} mb={35} className={styles.body} >
