...
function About() {
    ...
    return (
        <Box fontFamily={"ZCOOL XiaoWei"} className={styles.body} p={20}>
            <Flex justify='center'><Heading pl={20} fontFamily={"ZCOOL XiaoWei"} fontSize={72} color="#fcffea">关于我们</Heading></Flex>
            <Text pt={10} fontSize={60} color="#fafafa">历史</Text>
            <Flex justify={'center'} align='center'>
                <Text mt={5} pt={'36px'} pb={'33px'} pl={'21px'} pr='21px' fontSize={24} w={1227} bgColor="#000000" color="#fafafa">亚太大专华语辩论公开赛是南洋理工大学中文学会的常年活动之一，曾被评论为全球四大国际华语辩论赛之一。它的前身为“新马大专华语辩论赛”。
